...
- (void)viewDidLayoutSubviews{
    ...
    self.mainScrollView.frame = CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT - (71 + [SHUIScreenControl liuHaiHeight]) - 44 - 5);
    ...
    for (NSInteger i = 0; i < _viewControllers.count; i++) {
        ...
        child.view.frame = CGRectMake(i * self.view.frame.size.width, child.view.frame.origin.y, child.view.frame.size.width, MAINHEIGHT - 44 - 40 - (71 + [SHUIScreenControl liuHaiHeight]));
