...
-(UIButton *)explanationBtn{
    ...
    if (!_explanationBtn) {
        ...
        [[_explanationBtn rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(__kindof UIControl * _Nullable x) {
            ...
            NSString * urlStr = [[NSString alloc] initWithFormat:@"%@/index/Html/article?article_id=%@",CARDOMAIN,@"8"];
            SHBaseWKWebViewController * vc = [[SHBaseWKWebViewController alloc] initWithTitle:@"业务回访" andIsShowBackBtn:YES andURLStr:urlStr];
