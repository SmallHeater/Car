...
static NSString * cellID = @"SHCarouselCollectionViewCell";

@interface SHCarouselView ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate>

@property (nonatomic,assign) PageControlType pageControlType;
@property (nonatomic,strong) NSMutableArray<SHCarouselDataModel *> * dataArray;
...
-(NSMutableArray<SHCarouselDataModel *> *)dataArray{
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SHCarouselDataModel * model = self.dataArray[indexPath.row];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SHCarouselCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
-(void)refreshData:(NSArray<NSDictionary *> *)array{
    ...
    for (NSDictionary * dic in array) {
        ...
        SHCarouselDataModel * model = [SHCarouselDataModel mj_objectWithKeyValues:dic];
