...
-(void)setQRCode{
    ...
    output.rectOfInterest = CGRectMake(self.areaView.frame.origin.y/MAINHEIGHT, self.areaView.frame.origin.x/MAINWIDTH, self.areaView.frame.size.height/MAINHEIGHT, self.areaView.frame.size.width/MAINWIDTH);
    //初始化链接对象
