...
static HighOrderPositioningController * manager = nil;

@interface HighOrderPositioningController ()<AMapLocationManagerDelegate>

@property (nonatomic, strong) AMapLocationManager *locationManager;

@end

@implementation HighOrderPositioningController
