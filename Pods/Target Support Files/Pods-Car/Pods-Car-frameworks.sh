...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PLeakSniffer/PLeakSniffer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TXIMSDK_TUIKit_iOS/TXIMSDK_TUIKit_iOS.framework"
  install_framework "${PODS_ROOT}/TXIMSDK_iOS/ImSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Toast/Toast.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VehicleKeyboard-swift/VehicleKeyboard_swift.framework"
